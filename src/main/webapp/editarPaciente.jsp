            ...
            <section>
                <article id="registroPaciente">
                    <%
                        if (rz != null && rz.next()) {
                        %>
                        <form id="formRegistroDoctor" class="two-columns" action="editarPaciente.jsp?id=<%= idPaciente %>" method="post">
                            ...
                            <div class="field">
                                ...
                                <input type="email" id="correo" name="correo" value="<%= rz.getString("email") %>" required>
                            </div>
                            ...
                            <div class="field">
                                ...
                                <input type="date" id="fechanac" name="nacimiento" value="<%= rz.getString("fecha_nac") %>" required>
                            </div>
